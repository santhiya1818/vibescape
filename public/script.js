...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // =======================================================
    // --- HOME PAGE LOGIC (Only runs on home.html) ---
    // =======================================================
    // Use an element unique to home.html to run this block
    ...
    if (searchSection) {
        ...
        function selectPlaylistAndAdd(songTitle) { let playlists = getPlaylists();
